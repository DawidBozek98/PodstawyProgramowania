# Write a program that checks that both people are adults. 
# Read people's data from the keyboard.
...
if person1_age >= 18 and person2_age >= 18:
    print(f'Both {person1_name} and {person2_name} are adults') #brakowało 'f' przed
else:
